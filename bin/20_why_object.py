...
In this section,
1. Encapsulation: Keeping data & related methods/variables together in ONE object/bag/container/bucket
2. Abstraction: Through methods. We just need to know how to use. NO need to know how it is implemented internally
"""
